class phpfpm::install (
  ...
  $epel_enabled           = '1',
  $epel_gpgcheck          = '0',
  $remi_mirrorlist        = "http://rpms.famillecollet.com/enterprise/$releasever/remi/mirror",
  $remi_enabled           = 1,
  $remi_gpgcheck          = 0,
  $remi55_mirrorlist      = "http://rpms.famillecollet.com/enterprise/$releasever/php55/mirror",
  $remi55_enabled         = 0,
  $remi55_gpgcheck        = 0,
  $remi56_mirrorlist      = "http://rpms.famillecollet.com/enterprise/$releasever/php56/mirror",
  $remi56_enabled         = 0,
  $remi56_gpgcheck        = 0,
) {
